export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-lavender-50/50 to-rose-50/30 dark:bg-slate-900 border-t border-rose-100 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 pt-8 border-t border-rose-100 dark:border-slate-800">
